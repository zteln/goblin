defmodule Goblin.DiskTable.Encoder do
  @moduledoc false
  @sst_block_id "GOBLINBLOCK00000"
  @sst_block_unit_size 1024
  @sst_header_size byte_size(<<@sst_block_id::binary, 0::integer-64>>)
  ...
  def encode_sst_block(triple, compress?) do
    ...
    data_size = byte_size(<<@sst_block_id::binary, 0::integer-64, data::binary>>)
    no_blocks = no_blocks(data_size)
    padding = no_blocks * @sst_block_unit_size - data_size

    sst_block =
      <<@sst_block_id::binary, no_blocks::integer-64, data::binary, 0::size(padding)-unit(8)>>
