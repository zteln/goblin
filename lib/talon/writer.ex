defmodule Talon.Writer do
  ...
  @spec get(writer(), key :: Talon.db_key()) :: {:ok, Talon.db_value()} | :error
  def get(writer, key) do
    GenServer.call(writer, {:get, key})
  end

  @spec put(writer(), Talon.db_key(), Talon.db_value()) :: :ok | {:error, term()}
  ...
  @spec put_multi(writer(), [{Talon.db_key(), Talon.db_value()}]) ::
          :ok | {:error, term()}
  ...
  @spec remove(writer(), Talon.db_key()) :: :ok | {:error, term()}
  ...
  @spec remove_multi(writer(), [Talon.db_key()]) :: :ok | {:error, term()}
