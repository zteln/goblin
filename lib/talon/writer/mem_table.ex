defmodule Talon.Writer.MemTable do
  @moduledoc false
  @type t :: map()
  ...
  @spec upsert(t(), Talon.db_sequence(), Talon.db_key(), Talon.db_value()) :: t()
  ...
  @spec delete(t(), Talon.db_sequence(), Talon.db_key()) :: t()
  def delete(mem_table, seq, key) do
    Map.put(mem_table, key, {seq, :tombstone})
  end

  @spec read(t(), Talon.db_key()) :: {:value, nil | Talon.db_value()} | :not_found
  ...
  @spec sort(t()) :: [{Talon.db_key(), {Talon.db_sequence(), Talon.db_value()}}]
  def sort(mem_table), do: Enum.sort(mem_table)

  @spec flatten(t()) :: [{Talon.db_sequence(), Talon.db_key(), Talon.db_value()}]
  def flatten(mem_table), do: Enum.map(mem_table, fn {key, {seq, value}} -> {seq, key, value} end)

  @spec advance_seq(t(), Talon.db_sequence()) :: t()
