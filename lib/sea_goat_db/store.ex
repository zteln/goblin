defmodule SeaGoatDB.Store do
  @moduledoc false
  use GenServer
  alias SeaGoatDB.Compactor
  ...
  @type data ::
          {BloomFilter.t(), SeaGoatDB.db_sequence(), non_neg_integer(),
  ...
  @spec get_ss_tables(GenServer.server(), SeaGoatDB.db_key()) :: [
  ...
  @spec tmp_file(SeaGoatDB.db_file()) :: SeaGoatDB.db_file()
