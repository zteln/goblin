defmodule SeaGoatDB.Manifest do
  @moduledoc false
  use GenServer
  ...
  @spec log_rotation(manifest(), SeaGoatDB.WAL.rotated_file()) :: :ok | {:error, term()}
  ...
  @spec log_compaction(manifest(), [SeaGoatDB.db_file()], [SeaGoatDB.db_file()]) ::
          :ok | {:error, term()}
