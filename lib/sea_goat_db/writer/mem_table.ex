defmodule SeaGoatDB.Writer.MemTable do
  @moduledoc false
  @type t :: map()
  ...
  @spec upsert(t(), SeaGoatDB.db_sequence(), SeaGoatDB.db_key(), SeaGoatDB.db_value()) :: t()
  ...
  @spec delete(t(), SeaGoatDB.db_sequence(), SeaGoatDB.db_key()) :: t()
  def delete(mem_table, seq, key) do
    Map.put(mem_table, key, {seq, :tombstone})
  end

  @spec read(t(), SeaGoatDB.db_key()) :: {:value, nil | SeaGoatDB.db_value()} | :not_found
  ...
  @spec sort(t()) :: [{SeaGoatDB.db_key(), {SeaGoatDB.db_sequence(), SeaGoatDB.db_value()}}]
  def sort(mem_table), do: Enum.sort(mem_table)

  @spec flatten(t()) :: [{SeaGoatDB.db_sequence(), SeaGoatDB.db_key(), SeaGoatDB.db_value()}]
  def flatten(mem_table), do: Enum.map(mem_table, fn {key, {seq, value}} -> {seq, key, value} end)

  @spec advance_seq(t(), SeaGoatDB.db_sequence()) :: t()
