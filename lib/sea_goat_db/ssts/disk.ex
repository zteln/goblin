defmodule SeaGoatDB.SSTs.Disk do
  defstruct [
    :io,
    :offset
  ]
  ...
  @spec open!(SeaGoatDB.db_file(), opts()) :: t()
  ...
  @spec open(SeaGoatDB.db_file(), opts()) :: {:ok, t()} | {:error, term()}
  def open(file, opts \\ []) do
  ...
  Renames `from` to `to`.
  """
  @spec rename(SeaGoatDB.db_file(), SeaGoatDB.db_file()) :: :ok | {:error, term()}
  ...
  Deletes `file`.
  """
  @spec rm(SeaGoatDB.db_file()) :: :ok | {:error, term()}
  def rm(file) do
