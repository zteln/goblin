defmodule SeaGoatDB.SSTs.SST do
  @moduledoc """
  An SST (Sorted String Table) implementation for the SeaGoatDB database.
  ...
  @type triple :: {SeaGoatDB.db_sequence(), SeaGoatDB.db_key(), SeaGoatDB.db_value()}
